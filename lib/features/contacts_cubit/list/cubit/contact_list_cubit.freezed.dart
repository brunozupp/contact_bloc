...
abstract class _Error implements ContactListCubitState {
  factory _Error({required final String message}) = _$_Error;
...
class _$_Success implements _Success {
  _$_Success({required this.message});
  ...
  @override
  String toString() {
    return 'ContactListCubitState.success(message: $message)';
  }
...
abstract class _Success implements ContactListCubitState {
  factory _Success({required final String message}) = _$_Success;
